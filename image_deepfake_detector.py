# -*- coding: utf-8 -*-
"""Image DeepFake Detector.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SgUuxwyC_82IXtde57oYufs3x7-Gwjv7
"""
...
len(os.listdir("/content/real_vs_fake/real-vs-fake/train/fake")), len(os.listdir("/content/real_vs_fake/real-vs-fake/train/real"))
...
classifier = nn.Sequential(OrderedDict([('fcl', nn.Linear(25088, 25)), #AlexNet = 9216 VGG16 = 25088
                                         ('relu', nn.ReLU()),
